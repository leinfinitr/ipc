...
void test_basic()
{
    ...
    ipc::node node("basic", ipc::ChannelType::NamedPipe);
...
void test_loop()
{
    ...
    ipc::node node("loop", ipc::ChannelType::NamedPipe);
    for (int i = 0; i < 20; ++i) {
...
void test_struct()
{
    ...
    ipc::node node("struct", ipc::ChannelType::NamedPipe);
...
void test_class()
{
    ...
    ipc::node node("class", ipc::ChannelType::NamedPipe);
...
void test_subclass()
{
    ...
    ipc::node node("subclass", ipc::ChannelType::NamedPipe);
